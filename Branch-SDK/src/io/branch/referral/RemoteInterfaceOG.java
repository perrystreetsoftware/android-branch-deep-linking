...
class RemoteInterfaceOG {
    ...
    public RemoteInterfaceOG(Context context) {
     ...
     * @return A {@link ServerResponse} object containing the result of the RESTful request.
     */
    private ServerResponse make_restful_get2(String baseUrl, JSONObject params, String tag, int timeout, int retryNumber, boolean log) {
